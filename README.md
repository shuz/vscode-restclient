...
## Variables
We support two types of variables, one is __Custom Variables__ which is defined by user and can be further divided into __Environment Variables__, __File Variables__, __Prompt Variables__, __Request Variables__  and __Script Variables__, the other is __System Variables__ which is a predefined set of variables out-of-box.
